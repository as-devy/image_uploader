<template>
    <div class="uploaded">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#47cd47" height="60px"
            width="60px" version="1.1" id="Capa_1" viewBox="0 0 512 512" xml:space="preserve">
            <g>
                <path
        ...
        <div class="uploaded-img" ref="uploadedImg" :style="`background-image: url(${imgUrl})`"></div>
        <div class="img-url">
            <input type="text" ref="urlInput" :value="imgUrl">
            <button class="btn" @click="copyToClipboard" ref="copyBtn">Copy Link</button>
        </div>
    </div>
...
export default {
    ...
    setup(props) {
        ...
        const copyToClipboard = () => {
            ...
            urlInput.value.style.borderColor = "#2f80ed"
            urlInput.value.select()
            setTimeout(() => {
                copyBtn.value.textContent = "Copy Link"
            }, 1000)
        }

        return { copyToClipboard, urlInput, copyBtn }
    }
}
</script>
